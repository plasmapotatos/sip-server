...
class BaselineModel:
    ...
    def eval_consistency(self, vid_path, frames, description):
        ...
        prompt = "Your job is to determine whether the following description and explanation are consistent with what happens in a video. The description was generated by another AI model, which got the same set of frames as you will. Begin your output with a confidence score between 0 and 1, where 0.000 indicates a description inconsistent with the output, while 1.000 indicates a thorough and accurate description of the given frames. Decimals are allowed up to 3 decimal places. Then, justify your confidence score. Here is the description: "
        response = self.client.chat.completions.create(
            model=self.MODEL,
            messages=[
...
if __name__ == "__main__":
    ...
    responses = BaselineModel.predict_custom_safety(model, directory=vid_directory, vidnums=[1])
    print(responses)